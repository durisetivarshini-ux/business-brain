      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-white text-sm font-bold hover:bg-white/10 transition-colors flex items-center gap-2"
          >
            <Upload size={14} /> Import Data
          </button>
          <button
            onClick={() => setModal('addLead')}
            className="px-4 py-2 rounded-xl bg-gradient-to-r from-[#5B5FFF] to-[#7C3AED] text-white text-sm font-bold shadow-[0_0_15px_rgba(91,95,255,0.4)] transition-transform hover:scale-[1.02]"
          >
            + Add Lead
          </button>
        </div>
