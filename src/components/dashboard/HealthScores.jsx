...
export function HealthScores() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10 w-full mb-6">
      ...
      <GlassCard className="p-6 border-[#00D4FF]/30 bg-gradient-to-r from-[#0B1120]/90 to-[#050816]/90 flex items-center gap-6 relative overflow-hidden group">
        ...
        <div className="relative w-28 h-28 shrink-0 flex items-center justify-center">
          <svg className="w-full h-full transform -rotate-90">
            ...
            <motion.circle 
              ...
              strokeDasharray="314" strokeDashoffset={314 - (314 * 88) / 100}
              strokeLinecap="round"
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="text-3xl font-display font-bold text-white"><CountUp end={88} duration={2}/></span>
      ...
      <GlassCard className="p-6 border-[#5B5FFF]/30 bg-gradient-to-r from-[#0B1120]/90 to-[#050816]/90 flex items-center gap-6 relative overflow-hidden group">
        ...
        <div className="relative w-28 h-28 shrink-0 flex items-center justify-center">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <span className="text-[10px] font-bold text-[#5B5FFF] uppercase tracking-widest mt-1">Rating</span>
          </div>
        </div>
      </GlassCard>
